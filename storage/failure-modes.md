...
| 9 | **Conflicting version write** | Version pinning on the governed write path | **BLOCK**, then **RECONCILE** by re-reading and re-applying | Last-write-wins silently discards a governed change. The writer re-reads and decides |
