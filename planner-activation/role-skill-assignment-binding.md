...
**Rule RB-4 — registry contents are derived from the approved documents at read time.** The
reference implementation parses `roles/master-role-universe.md`, `skills/master-skill-universe.md`,
`reviews/master-review-profile-universe.md`, the `decisions/` register and `workflows/`. It
derives the Role count rather than hard-coding it: a phase that wrote "59" would still say 59
after something added a sixtieth.
