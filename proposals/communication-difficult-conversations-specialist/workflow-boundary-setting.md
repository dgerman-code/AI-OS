...
**Rule BS-1 — authority and review satisfaction are separate, and neither cures the other.**
...
in a draft, decided on the record by the holder of the applicable Right; none of the three items above is a placeholder, so the exception does not reach them. This Workflow
